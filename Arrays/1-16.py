...
ascending_distances_traveled = sorted(distances_traveled)
descending_daily_temperatures = sorted(daily_temperatures, reverse=True)
ascending_file_names = sorted(file_names)

print(distances_traveled)
print(ascending_distances_traveled)
print(daily_temperatures)
print(descending_daily_temperatures)
print(file_names)
print(ascending_file_names)